...
class FavoritesUseCaseImp @Inject constructor(
    private val placesRepository: PlacesRepository,
    private val mapper: PlaceMapper
) : FavoritesUseCase {
    override suspend fun getFavoritePlaces(): Flow<DataState<List<Place>>> = flow {
    ...
    override suspend fun setFavoritePlaces(id: Int, isFavorite: Boolean) {
